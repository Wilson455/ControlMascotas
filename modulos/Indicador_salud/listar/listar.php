            ...
            <div class="row">
                <div style="text-align: center;">
                    <div class="page-header">
                        <h2>Indicador De Salud Para La Mascota #<?php echo $_SESSION['idMascota']; ?></h2>
                    </div>
                </div>
            </div>
            <div style="margin: auto;text-align: center;width:50%;">
                <table id="listarIndicadorSalud" class="table table-striped example" style="width:100%; margin: auto;">
                    <thead>
                        <tr>
                            <th>Id</th>
                            <th>Peso</th>
